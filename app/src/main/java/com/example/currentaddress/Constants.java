...
class Constants {
    ...
    static final String ROOM_TYPE_SINGLE = "SINGLE BED";

    static final String ROOM_TYPE_DOUBLE = "DOUBLE BED";

    static final String ROOM_TYPE_TRIPLE = "TRIPLE BED";

    static final String ROOM_TYPE_FOUR = "FOUR BED";
